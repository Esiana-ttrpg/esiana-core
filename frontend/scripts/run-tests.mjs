...
const result = spawnSync(
  ...
  [
    ...
    'src/lib/entityPageShells/genericWikiShell.test.ts',
    'src/lib/entityPageShells/loreWritingUx.test.ts',
    'src/lib/prosePrimarySubview.test.ts',
    ...
    'src/lib/pageExport/downloadTextFile.test.ts',
  ],
