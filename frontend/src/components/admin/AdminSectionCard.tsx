import { META_FIELD_LABEL_CLASS, META_SECTION_LABEL_CLASS, SURFACE_OPERATIONAL_CLASS } from '@/lib/surfaceLayout';
...
export function AdminSectionCard({
  ...
  return (
    <section className={`rounded-md border border-border/40 bg-depth-1/40 p-6 ${SURFACE_OPERATIONAL_CLASS}`}>
