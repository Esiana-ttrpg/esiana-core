...
| `ENABLE_PLUGIN_CONNECTION_FIXTURES` | `false` | Optional | Explicitly enables isolated non-production OAuth/API-key fixture endpoints. Ignored in production. | `true` |
