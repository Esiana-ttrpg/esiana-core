> Archived 2026-06-15. Release history after v1.0.1: [GitHub Releases](https://github.com/Esiana-ttrpg/esiana-core/releases).
...
- **GitHub Release notes** — Tag releases use GitHub generated release notes plus GHCR pull instructions (no longer extracted from `changelog.md`).
- **Planning docs retired** — `todo.md` and `changelog.md` replaced with stubs; full history archived under `docs/archive/`. Backlog and roadmap tracked via GitHub Issues and Milestones; release history on GitHub Releases.
